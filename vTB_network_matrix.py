...
#descriptionfolder = "/n/data1/hms/dbmi/farhat/sbassler/pyrazinamide/files/description/"
...
##########################Load SNPs############################################
#input_file = filefolder+"Single_SNP_prob_500.csv"
#Single_SNP_prob ={}
#Single_SNP_probs =[]
#Single_SNP_probp =[]
#with open(input_file, "r") as csvfile:
...
input_file = filefolder+"Multi_SNP_prob_500.csv"
Multi_SNP_prob ={}
Multi_SNP_probs =[]
Multi_SNP_probp =[]
element_dict={}
